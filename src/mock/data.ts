...
export const MOCK_FEEDBACK_TREND: QueryTrendPoint[] = [
  { date: '08-08', count: 5 },
  { date: '08-09', count: 8 },
  { date: '08-10', count: 6 },
  { date: '08-11', count: 11 },
...
function fb(type: FeedbackType, status: FeedbackStatus, extra: Partial<FeedbackItem>): FeedbackItem {
  return { type, status, ...extra } as FeedbackItem
}

export const MOCK_FEEDBACK: FeedbackItem[] = [
  fb('correction', 'pending', {
    id: 101,
    sourceType: 'knowledge',
    sourceId: 1,
    sourceTitle: '支付回调常见问题排查',
    categoryPath: '支付平台 › 故障排查',
    content: '第二步签名验证示例代码有误，应该是 createHmac 而不是 createHash，请修正。',
    createdByName: '李小明',
    createdByRole: 'MEMBER',
    createdAt: '2026-08-14T09:12:00+08:00',
  }),
  fb('suggestion', 'pending', {
    id: 102,
    sourceType: 'knowledge',
    sourceId: 11,
    sourceTitle: 'API 接口认证方式说明',
    categoryPath: '开放平台 › API 文档',
    content: '建议补充 v2 版本 API 的 Bearer Token 鉴权方式，目前只讲了 v1 的 Basic Auth。',
    createdByName: '王小红',
    createdByRole: 'MEMBER',
    createdAt: '2026-08-14T08:40:00+08:00',
  }),
  fb('dislike', 'pending', {
    id: 103,
    sourceType: 'knowledge',
    sourceId: 8,
    sourceTitle: '订单批量导出方法',
    categoryPath: '订单中心 › 数据导出',
    content: '按照文档操作导出的格式和描述不一致，少了两列字段。',
    createdByName: '赵大伟',
    createdByRole: 'MEMBER',
    createdAt: '2026-08-13T17:02:00+08:00',
  }),
  fb('like', 'processing', {
    id: 104,
    sourceType: 'answer',
  ...
  fb('suggestion', 'processing', {
    id: 106,
    sourceType: 'knowledge',
    sourceId: 7,
    sourceTitle: 'SSO 单点登录集成指南',
    categoryPath: '账户系统 › 认证安全',
    content: '建议补充 OIDC 的 PKCE 流程说明，目前只提到标准授权码模式。',
    createdByName: '周敏',
    createdByRole: 'MEMBER',
    createdAt: '2026-08-12T16:22:00+08:00',
  }),
  fb('dislike', 'resolved', {
    id: 107,
    sourceType: 'knowledge',
    ...
    sourceTitle: '退款流程说明',
    categoryPath: '订单中心 › 退款流程',
    content: '文中说退款实时到账，但实际跨境支付要 3-5 个工作日，请核实。',
    createdByName: '吴磊',
    createdByRole: 'MEMBER',
    createdAt: '2026-08-11T14:18:00+08:00',
    handleNote: '已核实：跨境退款因渠道差异需 3-5 个工作日，已更新文档补充说明。',
    handledAt: '2026-08-12T09:40:00+08:00',
    handlerName: '张小美',
  }),
  fb('correction', 'resolved', {
    id: 108,
    sourceType: 'knowledge',
    sourceId: 3,
    sourceTitle: '微信支付回调通知说明',
    categoryPath: '支付平台 › 渠道接入',
    content: '回调应答要求返回 JSON 而不是纯文本，文档未说明格式。',
    createdByName: '郑浩',
    createdByRole: 'MEMBER',
    createdAt: '2026-08-10T11:26:00+08:00',
    handleNote: '已补充应答格式说明（success/fail JSON）。',
    handledAt: '2026-08-10T18:05:00+08:00',
    handlerName: '张小美',
  }),
  fb('like', 'resolved', {
    id: 109,
    ...
    sourceTitle: '支付回调常见问题排查',
    categoryPath: '支付平台 › 故障排查',
    content: '按照排查步骤解决了客户问题，文档很实用。',
    createdByName: '林芳',
    createdByRole: 'MEMBER',
    createdAt: '2026-08-09T09:50:00+08:00',
    handleNote: '已确认采纳，无内容变更。',
    handledAt: '2026-08-09T15:12:00+08:00',
    handlerName: '王大伟',
  }),
  fb('suggestion', 'resolved', {
    id: 110,
    sourceType: 'knowledge',
    sourceId: 10,
    sourceTitle: '企业微信集成配置',
    categoryPath: '通知服务',
    content: '建议增加消息推送的模板示例，方便直接复制。',
    createdByName: '冯婷',
    createdByRole: 'MEMBER',
    createdAt: '2026-08-08T13:40:00+08:00',
    handleNote: '已补充两套消息模板示例。',
    handledAt: '2026-08-09T10:20:00+08:00',
    handlerName: '张小美',
  }),
  fb('dislike', 'resolved', {
    id: 111,
    ...
    createdByName: '许明',
    createdByRole: 'MEMBER',
    createdAt: '2026-08-07T15:44:00+08:00',
    handleNote: '已补充：回调超时 30 秒，超时后进入重试队列。',
    handledAt: '2026-08-08T09:10:00+08:00',
    handlerName: '王大伟',
  }),
  fb('like', 'resolved', {
    id: 112,
    ...
    handleNote: '已确认采纳。',
    handledAt: '2026-08-06T16:00:00+08:00',
    handlerName: '张小美',
  }),
]
